...
// import org.apache.hadoop.fs.cosn.commit.magic.MagicCOSGuardCommitterFactory;
import org.apache.hadoop.fs.cosn.commit.staging.DirectoryStagingCommitterFactory;
import org.apache.hadoop.fs.cosn.commit.staging.PartitionedStagingCommitterFactory;
import org.apache.hadoop.fs.cosn.commit.staging.StagingCommitterFactory;
...
/**
 * The COS committer factory which chooses the committer based on the
 ...
 * the committer.
 */
public class COSCommitterFactory extends org.apache.hadoop.fs.cosn.commit.AbstractCOSCommitterFactory {

  /**
   * Name of this class: {@value}.
   */
  public static final String CLASSNAME
      = "org.apache.hadoop.fs.cosn.commit.COSCommitterFactory";
  ...
  public PathOutputCommitter createTaskCommitter(CosNFileSystem fileSystem,
    ...
    org.apache.hadoop.fs.cosn.commit.AbstractCOSCommitterFactory factory = chooseCommitterFactory(fileSystem,
        outputPath,
    ...
    if (factory != null) {
      ...
      LOG.info("Using committer {} to output data to {}",
          (committer instanceof AbstractCOSCommitter
              ? ((AbstractCOSCommitter) committer).getName()
              : committer.toString()),
          outputPath);
      return committer;
    } else {
   ...
   */
  private org.apache.hadoop.fs.cosn.commit.AbstractCOSCommitterFactory chooseCommitterFactory(
      CosNFileSystem fileSystem,
      Path outputPath,
      Configuration taskConf) throws PathCommitException {
    org.apache.hadoop.fs.cosn.commit.AbstractCOSCommitterFactory factory;
