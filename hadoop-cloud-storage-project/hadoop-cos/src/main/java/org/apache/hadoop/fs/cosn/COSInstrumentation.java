...
import static org.apache.hadoop.fs.cosn.Statistic.*;

/**
 * Instrumentation of cos.
...
public class COSInstrumentation implements Closeable, MetricsSource {
    private static final Logger LOG = LoggerFactory.getLogger(
            COSInstrumentation.class);

    private static final String METRICS_SOURCE_BASENAME = "COSMetrics";

    /**
     * {@value #METRICS_SYSTEM_NAME} The name of the s3a-specific metrics
     * system instance used for s3a metrics.
     */
    public static final String METRICS_SYSTEM_NAME = "cos-file-system";

    /**
     * {@value #CONTEXT} Currently all s3a metrics are placed in a single
     * "context". Distinct contexts may be used in the future.
     */
    public static final String CONTEXT = "cosFileSystem";
     ...
     */
    public static final String METRIC_TAG_FILESYSTEM_ID = "cosFileSystemId";
    ...
    private final MetricsRegistry registry =
            new MetricsRegistry("cosFileSystem").setContext(CONTEXT);
    ...
    public COSInstrumentation(URI name) {
     ...
     * @param name cosn:// URI for the associated FileSystem instance
     */
    ...
    /**
     * Indicate that cos created a file.
     */
    ...
    /**
     * Indicate that cos deleted one or more files.
    ...
    /**
     * Indicate that cos created a directory.
     */
    ...
    /**
     * Indicate that cos just deleted a directory.
     */
    ...
    /**
     * Indicate that cos copied some files within the store.
     *
    ...
    /**
     * Instrumentation exported to cos Delegation Token support.
     */
    @InterfaceAudience.Private
    @InterfaceStability.Unstable
