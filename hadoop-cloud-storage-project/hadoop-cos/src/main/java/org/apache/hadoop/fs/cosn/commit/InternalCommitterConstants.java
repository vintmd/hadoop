...
import static org.apache.hadoop.fs.cosn.commit.CommitConstants.MAGIC;
import static org.apache.hadoop.fs.cosn.commit.CommitConstants.MAGIC_COMMITTER_ENABLED;
...
public final class InternalCommitterConstants {
   ...
   */
  public static final String FS_COS_COMMITTER_STAGING_UUID =
      "fs.cos.committer.staging.uuid";
